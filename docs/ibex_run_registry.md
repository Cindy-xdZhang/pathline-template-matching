...
| `50966318` | `Verify_ArcLengthResampling_1.1` analytic verification | 提交 2026-08-28 20:41:54 +03:00；等待开始/结束 | `QUEUED` | 验证1000个 `dx×RK4 ds×target spatial arc length` tuple 的七线积分、精确弧长截断、32点等弧长采样和批次/顺序不变性；基础设施验证，不产生模板匹配性能结论 | 等待分配 | commit `59d54903d1f0f9d7525f69ceed136d08fd6797ed`；Verify config SHA-256 `357d01c5d170e5ff7033060115622c687f33ca666fb03bed29c65600d0899989`；main config SHA-256 `89b66176eb381eddc62d739dacafe86e681b60455f1ffb5e5f34ee9af8c81d1d` | stdout `slurm_logs/PTMarcverify.50966318.out`；stderr `slurm_logs/PTMarcverify.50966318.err`；预定 output `outputs/Verify_ArcLengthResampling_1.1/slurm_50966318_59d54903d1f0/verification.json` |
