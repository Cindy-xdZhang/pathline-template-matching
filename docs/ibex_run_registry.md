...
| `50930751` | `mainExp_TemplateMatching_1.1` cache-backed development（debug 2h 替代投递） | 提交 2026-08-27 17:17:22 +03:00；开始 17:18:17；结束待更新 | `RUNNING`；43/43 job内测试与 CUDA matcher gate 已通过 | 正在生成 exposed-development 描述性证据；不是 sealed confirmation | `gpu510-32`；1×Tesla V100-PCIE-32GB、16 CPU、64 GB | commit/config 与 `50930724` 完全相同 | stdout `slurm_logs/PTMdev11.50930751.out`；stderr `slurm_logs/PTMdev11.50930751.err`；output `outputs/mainExp_TemplateMatching_1.1_development/runs/slurm_50930751_ccc34bae4d9e` |
