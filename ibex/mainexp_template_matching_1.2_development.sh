...
RUN_DIR="outputs/mainExp_TemplateMatching_1.2_development/runs/slurm_${SLURM_JOB_ID}_${SHORT_COMMIT}"

echo "experiment=mainExp_TemplateMatching_1.2"
echo "phase=development_cache_backed"
echo "revision=skip_both_classes_and_audit_for_empty_library_strata"
...
python scripts/run_mainexp_development.py \
  --config config/mainExp_TemplateMatching_1.2_development.yaml \
  --run-dir "$RUN_DIR" \
