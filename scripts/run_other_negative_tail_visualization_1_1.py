#!/usr/bin/env python3
"""Render the frozen NegativeTail outer-fold classifier on four 3D flows."""
...
DEFAULT_CONFIG = ROOT / "config/Other_NegativeTailVisualization_1.1.yaml"


def _git_commit_and_clean() -> str:
    critical_paths = (
        "config/Other_NegativeTailVisualization_1.1.yaml",
...
def main() -> None:
    ...
    result = run_negative_tail_visualization(
        plan,
        run_dir=run_dir,
        git_commit=commit,
    )
